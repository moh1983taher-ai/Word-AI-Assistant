...
بالاعتماد على معلومات ببليوغرافية موثوقة عن الكتاب نفسه، لا
على التخمين أو الاستنتاج من عنوانه أو مجاله أو سياقه.

إذا كان مؤلف الكتاب معروفًا ومشهورًا في المراجع الببليوغرافية،
فأدرجه باسم الشهرة العلمي المختصر، ولا تستبدل ذلك بالاسم الكامل.

إذا لم تتوفر لديك معلومة موثوقة تثبت مؤلف الكتاب، فاترك
author فارغًا.
`
    : `
=====================================================
...
لا تضف مؤلفًا غير مذكور في المادة الأصلية.
`
}
