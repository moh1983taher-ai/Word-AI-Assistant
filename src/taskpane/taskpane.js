...
ومع المؤلف عندما يكون مذكورًا في المادة الأصلية.

إذا كان عنوان الكتاب مميزًا ولا يُعرف به إلا كتاب واحد لمؤلف واحد،
فاحفظ هوية الكتاب ونسبته الصحيحة.
...
إذا لم يكن المؤلف مذكورًا، فاترك author فارغًا،
ولا تحذف المرجع.

إذا كانت النسبة الواردة في النص غير واضحة، فلا تغيّرها من عندك.
...
عند تفعيل هذا الخيار، حاول تحديد مؤلف المرجع إذا كان غير
مذكور في الحاشية، اعتمادًا على هوية الكتاب ومعرفتك
الببليوغرافية به.

استفد من عنوان الكتاب ومجموع المراجع والمجال العلمي العام
للوصول إلى المؤلف الصحيح عند إمكان ذلك.
