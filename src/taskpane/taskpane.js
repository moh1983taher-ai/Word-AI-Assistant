...
// مع فصل تعليمات النظام عن مادة السؤال
// =====================================================
...
async function streamGeminiAI(
    ...
    // ==================================
    // تعليمات النظام
    // نرسلها مرة واحدة كتعليمات مستقلة
    // ==================================
    ...
    const systemInstruction = [
        ...
        "إذا كان السؤال يتضمن أكثر من جانب فأجب عن الجوانب التي تدعمها المادة.",
        ...
        "لا تحول كل مقطع إلى فقرة مستقلة؛ قدم خلاصة تركيبية.",

        "بعد كل فكرة مستندة إلى المادة ضع الإحالة المناسبة بصيغة [مقطع X].",

        "اجمع الإحالات المتعددة عندما تدعم الفكرة نفسها.",
