...
لا تغيّر مؤلفًا مذكورًا في النص.
...
عند تفعيل هذا الخيار، حاول تحديد مؤلف المرجع الذي لا يذكر
النص مؤلفه، بعد تحديد هوية الكتاب.

استفد من عنوان الكتاب ومجموع المراجع في المستند ومجالها
العلمي للوصول إلى المؤلف الصحيح.

استخدم اسم الشهرة العلمي المختصر.

إذا لم تتمكن من تحديد المؤلف بصورة موثوقة، فاترك author فارغًا.
`
    : `
=====================================================
3.1 تقصي أسماء المؤلفين
