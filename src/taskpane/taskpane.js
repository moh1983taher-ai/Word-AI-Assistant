...
=====================================================
قاعدة نسبة الكتاب إلى مؤلفه — حاسمة
=====================================================

لا تنسب كتابًا إلى مؤلف لمجرد تشابه العنوان أو لأن هناك أكثر
من كتاب بالعنوان نفسه.

إذا لم يذكر المؤلف في الحاشية، فلا تخمّن اسم المؤلف إلا إذا كانت
هوية الكتاب ومجاله العلمي والمؤشرات المحيطة به تجعل النسبة واضحة
بدرجة عالية جدًا.

وعند الشك:

اترك author فارغًا،
ولا تستبدله باسم مؤلف محتمل.

خصوصًا في العناوين المشهورة التي لها أكثر من استعمال أو أكثر من
كتاب، يجب التحقق من نسبة الكتاب إلى مؤلفه بحسب مجاله العلمي.

مثال:

"شرح التسهيل" في سياق النحو هو شرح ابن مالك لتسهيله،
ولا يجوز نسبته إلى الرضي الاستراباذي لمجرد وجود كتب أو شروح أخرى
متعلقة بالتسهيل.

"الإنصاف" في سياق مسائل الخلاف النحوي يقصد به كتاب ابن الأنباري،
ولا يجوز نسبته إلى مؤلف آخر.

"المقاصد الشافية" في سياق شرح الخلاصة الكافية هو كتاب الشاطبي.

إذا لم تكن النسبة مؤكدة، اترك اسم المؤلف فارغًا
ولا تخترع اسمًا.

الدقة في هوية الكتاب أهم من ملء خانة author.
...
=====================================================
قاعدة حصر جميع المراجع الظاهرة في المادة
=====================================================

عند تحليل أي مادة، احصر أولًا جميع المراجع أو عناوين الكتب
أو المصادر التي يظهر أنها مستشهد بها صراحة في النص.

كل مرجع مستقل ظاهر في المادة يجب أن ينتج عنه سجل مرجع مستقل
في النتيجة.

ممنوع الاكتفاء ببعض المراجع وترك بعضها.

إذا كانت المادة:

شرح التسهيل 2/7، الجنى الداني 580، شرح قطر الندى 149، مغني اللبيب 379

فهذه أربعة مراجع مستقلة، ويجب إنشاء أربعة سجلات واثبات
أربعة occurrences مرتبطة بالمادة نفسها.

يجب عدم إسقاط أي عنوان مرجعي ظاهر لمجرد أن التعرف على مؤلفه
أو تفاصيله أقل يقينًا.

إذا كان اسم الكتاب واضحًا لكن المؤلف غير مؤكد:
احتفظ بالكتاب، واترك author فارغًا أو استخدم needsReview.

=====================================================
التمييز بين تعدد المراجع وتعدد المواضع
=====================================================

إذا تكرر الكتاب نفسه داخل المادة مع أكثر من موضع:

شرح ابن يعيش 8/147، 9/95

فهذا مرجع واحد:
author/title واحدان،
وموضعان داخل locations.

أما إذا ظهرت عناوين مختلفة:
...
فهذه مراجع مستقلة،
ولا يجوز دمجها في سجل واحد أو إسقاط أي منها.

=====================================================
فحص نهائي لكل مادة
=====================================================

بعد تحليل المادة، راجع النص الأصلي مرة ثانية.

عدّ عناوين الكتب والمصادر الواضحة التي تحتوي على استشهاد أو
رقم صفحة/مجلد.

تأكد أن كل واحد منها ظهر في النتيجة إما:

- كسجل مرجع مستقل،
أو
- كموضع إضافي لمرجع سبق اكتشاف أنه الكتاب نفسه.

إذا وجدت عنوانًا مرجعيًا في النص ولم تجد له سجلًا أو occurrence،
فأعد تحليله قبل إخراج JSON.

لا تعتبر اكتمال التحليل متحققًا بمجرد استخراج أول مرجع أو أول مرجعين.
...
كل مرجع مستقل ظاهر في النص الأصلي يجب أن يحصل على سجل مستقل،
حتى لو لم يمكن تحديد المؤلف أو بعض البيانات الببليوغرافية بثقة.

إذا كان المرجع ظاهرًا في النص الأصلي بوضوح، فلا يجوز حذفه بسبب
عدم التأكد من المؤلف أو بعض بياناته، بل يُحتفظ به ويُترك الحقل
غير المؤكد فارغًا.

ولا يجوز إنشاء مرجع غير موجود في النص الأصلي.
...
=====================================================
التكرار في الحواشي لا يعني حذف الحاشية
=====================================================

إذا ورد المرجع نفسه في حاشيتين متتاليتين أو أكثر،
فلا تحذف أي حاشية من الحواشي.

كل حاشية مستقلة في المستند يجب أن تحتفظ بظهورها الخاص
وبـoccurrence الخاص بها.

يمكن دمجها في سجل مرجع موحد واحد،
لكن يجب أن تبقى جميع occurrences محفوظة.

مثال:

الحاشية 5:
الشاهد وأصول النحو في كتاب سيبويه 129، 134

الحاشية 6:
الشاهد وأصول النحو في كتاب سيبويه 129، 134

هما ظهوران مستقلان للمرجع نفسه،
وليسا ظهورًا واحدًا.

إذن:
مرجع موحد واحد + occurrence للحاشية 5 + occurrence للحاشية 6.
=====================================================
قاعدة الدقة في استخراج المراجع
=====================================================

كن حريصًا جدًا عند استخراج المراجع من المادة الأصلية.

لا تحذف مرجعًا واضحًا أو تتجاهله لمجرد أن المادة تحتوي
على مراجع أخرى.

وجود رقم صفحة أو مجلد/صفحة أو نطاق صفحات علامة قوية
على وجود استشهاد مرجعي يجب الاحتفاظ به وتحليله.

مثل:

الكتاب 3/22، والأصول 2/220

يجب ألا تختار "الكتاب 3/22" وتترك "الأصول 2/220".
كلاهما مرجع مستقل.

ومثل:

شرح ابن يعيش 8/147، وشرح التسهيل 1/39 4/108،
والجنى الداني 255، ومغني اللبيب 230-231

يجب استخراج المراجع الظاهرة التي تدل عليها هذه المواضع،
ولا يجوز إسقاط مرجع واضح لمجرد أن التعرف على مؤلفه أقل يقينًا.

إذا كان المرجع واضح العنوان أو واضح الموضع،
لكن المؤلف غير مؤكد، احتفظ بالمرجع واترك المؤلف فارغًا
أو استخدم needsReview بدل حذف المرجع.

إذا كان المرجع يحتوي على رقم صفحة أو مجلد/صفحة،
فلا تعتبره شرحًا أو نصًا عابرًا إلا إذا كان السياق يثبت ذلك بوضوح.

عند الشك بين:
"الاحتفاظ بالمرجع مع ثقة أقل"
و
"حذف المرجع"
...
لكن لا تحذف مرجعًا موجودًا وواضحًا في المادة الأصلية.
...
لكن إذا احتوى الشرح على اسم كتاب أو عنوان أو رقم صفحة
يدل بوضوح على استشهاد مرجعي، فاستخرج المرجع أو المراجع الموجودة فيه.
...
=====================================================
قاعدة التقاط جميع المواضع والأرقام
=====================================================

إذا ورد المرجع نفسه ومعه أكثر من موضع أو أكثر من رقم،
فيجب التقاط جميع المواضع المرتبطة به، وليس أول موضع فقط.

مثال:

شرح التسهيل 1/39 4/108
...
السيوطي، الأشباه 92-93

يجب الاحتفاظ بالنطاق كاملًا:
92-93
...
إذا جاء بعد اسم الكتاب أكثر من تعبير رقمي يدل على المجلد
والصفحة أو أكثر من صفحة أو نطاق صفحات، فافترض أنها مواضع
متعددة للمرجع نفسه ما لم يدل السياق بوضوح على أنها تخص
مرجعًا آخر.

يجب مراجعة النص الأصلي كاملًا قبل إخراج المرجع والتأكد من
عدم سقوط أي رقم أو موضع متعلق به.

لا تكتفِ بأول رقم يظهر بعد عنوان المرجع.
=====================================================
الثقة والمراجعة
=====================================================
