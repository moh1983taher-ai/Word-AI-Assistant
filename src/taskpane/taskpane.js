...
فاحفظ جميع المواضع الخاصة به في locations.

لا تحذف موضعًا من مواضع المرجع نفسه،
ولا تنقل موضعًا إلى مرجع آخر.
...
=====================================================
11. الدقة وعدم التخمين
=====================================================

كن حريصًا في استخراج المراجع.

إذا كان المرجع واضحًا في النص،
فلا تحذفه.

إذا كان عنوان الكتاب واضحًا لكن المؤلف غير مؤكد،
احتفظ بالمرجع واترك author فارغًا أو استخدم needsReview.

لا تخترع مؤلفًا أو عنوانًا أو ناشرًا أو سنة غير موجودة.

اسم مؤلف غير مؤكد أفضل من نسبة الكتاب إلى مؤلف خاطئ.
