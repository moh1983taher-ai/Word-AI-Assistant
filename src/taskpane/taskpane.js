...
إذا كان عنوان الكتاب واضحًا والمؤلف غير مؤكد،
احتفظ بالكتاب واترك author فارغًا أو استخدم needsReview.

اسم مؤلف فارغ أفضل من اسم مؤلف خاطئ.

إذا كان المؤلف مذكورًا في المادة نفسها بوضوح،
احتفظ به.

وفي الكتب المشهورة ذات العناوين المتشابهة،
لا تنسب الكتاب إلى مؤلف آخر إلا إذا كانت النسبة واضحة بدرجة عالية.

=====================================================
4. المراجع المتعددة داخل المادة
=====================================================

المادة الواحدة قد تحتوي على عدة مراجع مستقلة.

مثال:

شرح التسهيل 2/7، الجنى الداني 580، شرح قطر الندى 149، مغني اللبيب 379

هذه أربعة مراجع مستقلة:
...
يجب استخراج كل مرجع مستقل.

لا تكتفِ بأول مرجع.

إذا كان المرجع ظاهرًا بوضوح في النص،
فلا تحذفه بسبب نقص معلوماته أو عدم التأكد من مؤلفه.

ولا تنشئ مرجعًا غير موجود في النص الأصلي.

=====================================================
5. امتداد المرجع ومواضعه
=====================================================

بعد التعرف على بداية مرجع معين، اعتبر جميع أرقام المجلدات
والصفحات أو نطاقات الصفحات التي تأتي بعده جزءًا من المرجع نفسه،
إلى أن يظهر انتقال واضح إلى مرجع آخر.

مثال:

شرح التسهيل 1/39 4/108، الجنى الداني 580
...
الكتاب 3/247، 4/430، 5/22، والأصول 2/220
...
لا تعتبر كل رقم مرجعًا جديدًا.

لا تتوقف عند أول رقم بعد اسم الكتاب.

استمر في التقاط جميع المواضع التابعة للمرجع الحالي
حتى يظهر انتقال واضح إلى مرجع آخر، مثل:

- ظهور عنوان كتاب آخر.
- ظهور مؤلف آخر.
- ظهور اسم مصدر أو مجلة أو بحث جديد.
- ظهور صيغة واضحة تدل على بداية مصدر آخر.

احتفظ بجميع المواضع التابعة للمرجع الحالي،
ولا تسقط أي موضع.

إذا اختلف عنوان الكتاب أو ظهر مصدر جديد بوضوح،
فابدأ مرجعًا مستقلًا جديدًا.

=====================================================
6. عدم حذف المواضع
=====================================================

إذا كان المرجع مصحوبًا برقم مجلد وصفحة،
فاحفظه كما ورد.
...
إذا كانت المادة تحتوي ثلاثة مراجع مستقلة،
فلكل مرجع occurrence مستقل.

جميع occurrences الناتجة من المادة نفسها تحمل materialId نفسه.
...
إذا كان "المصدر نفسه" بلا موضع أو سياق كافٍ،
لا تخترع مرجعًا.
...
لكن إذا احتوى الشرح على مرجع واضح،
...
variants للصيغ المختلفة للمرجع نفسه فقط.
...
كن حريصًا في استخراج المراجع.

إذا كان في النص مرجع واضح ومعه موضع أو صفحة،
فلا تحذفه.

عند الشك في المؤلف:
احتفظ بالمرجع واترك author فارغًا.

عند الشك بين حذف المرجع والاحتفاظ بمرجع واضح مع بيانات ناقصة،
احتفظ بالمرجع.
