...
المؤلف وحده لا يكفي لتحديد المرجع.
...
${addMissingAuthors
    ? `
=====================================================
3.1 التقصي عن أسماء المؤلفين عند تفعيل الخيار
=====================================================

عند تفعيل هذا الخيار، ابذل أقصى جهد معقول لتحديد اسم مؤلف
كل مرجع ظاهر في المواد، حتى إذا لم يذكر اسم المؤلف في الحاشية
الأصلية.

يجوز لك الاستفادة من معرفتك العلمية الموثوقة بالمصادر العربية
والإسلامية وكتب اللغة والفقه وأصول الفقه وغيرها لتحديد المؤلف.

المطلوب:
- حاول تحديد مؤلف كل كتاب أو مصدر يمكن تحديد مؤلفه بدرجة موثوقة.
- لا تترك author فارغًا لمجرد أن المؤلف لم يذكر في الحاشية.
- ابحث ذهنيًا في نسبة الكتب المشهورة إلى مؤلفيها قبل ترك المؤلف فارغًا.
- إذا كان للعنوان أكثر من كتاب، فحدد المؤلف بناءً على السياق
  وبقية بيانات المرجع، ولا تختَر مؤلفًا لمجرد التشابه في العنوان.
- إذا كان المرجع من الكتب المشهورة ذات المؤلف المعروف،
  فأدرج المؤلف.
- إذا كانت النسبة محتملة لكنها غير مؤكدة بدرجة كافية،
  استخدم needsReview = true ولا تقدّم النسبة على أنها يقينية.
- لا تخترع مؤلفًا.
- لا تخترع كتابًا.
- لا تغيّر عنوان المرجع لإيجاد مؤلف له.
- لا تنسب كتابًا إلى مؤلف لمجرد أن ذلك المؤلف له كتاب مشابه.

إذا استطعت تحديد المؤلف بدرجة موثوقة، فأعد اسم المؤلف في:
author

حتى لو لم يكن المؤلف مذكورًا في النص الأصلي للحاشية.
`
    : `
=====================================================
3.1 أسماء المؤلفين
