...
عند تفعيل هذا الخيار، حدّد الكتاب المقصود أولًا، ثم استخرج
مؤلفه الصحيح اعتمادًا على المعرفة الببليوغرافية الموثوقة.

ميّز بين الكتب التي تتشابه في العنوان قبل تحديد المؤلف.

استخدم اسم الشهرة العلمي المختصر المناسب للتوثيق.

إذا تعذر تحديد المؤلف بصورة موثوقة، فاترك author فارغًا.
`
    : `
=====================================================
3.1 تقصي أسماء المؤلفين
