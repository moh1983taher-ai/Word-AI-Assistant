...
هوية المرجع تعتمد أساسًا على عنوان الكتاب أو المصدر، ومع
المؤلف عندما تكون نسبته معلومة بدرجة موثوقة.

تُحدد هوية المرجع بالنظر إلى المراجع الواردة في المستند كله
ومجاله العلمي العام، ويُستفاد من ذلك في تمييز الكتب المتحدة
أو المتشابهة في العنوان.
...
نسبته إليه، فافصل اسم المؤلف عن عنوان الكتاب بحسب بنية
المرجع ونمط التوثيق المختار.

لا تفصل اسمًا من عنوان المرجع لمجرد كونه اسم شخص، فإذا كان
جزءًا أصيلًا من عنوان الكتاب فابقه ضمن العنوان.
...
لا تنسب الكتاب إلى مؤلف إلا إذا كانت نسبته إليه معلومة بدرجة
موثوقة.

إذا كان المؤلف مذكورًا في المادة الأصلية بوضوح، فاحتفظ به.

إذا لم يكن المؤلف مذكورًا أو لم يمكن تثبيت نسبته، فاترك
author فارغًا، ولا تحذف المرجع.

إذا كانت النسبة غير مؤكدة، اجعل needsReview = true.
...
عند تفعيل هذا الخيار، وبعد تحديد هوية الكتاب، حاول تحديد
مؤلفه إذا كان غير مذكور في الحاشية، اعتمادًا على معرفتك
الببليوغرافية بالكتاب نفسه.

إذا عرفت المؤلف الصحيح، فأدرجه باسم الشهرة العلمي المختصر.

إذا تعذر تحديد المؤلف، فاترك author فارغًا.
`
    : `
=====================================================
3.1 تقصي أسماء المؤلفين
...
لا تضف مؤلفًا غير مذكور في الحاشية.

احتفظ بالمؤلف المذكور في المادة الأصلية، واترك author فارغًا
إذا لم يكن المؤلف معلومًا منها.
`
}
=====================================================
