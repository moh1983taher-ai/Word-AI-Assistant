...
لا تستبدل هوية المرجع بهوية كتاب أو مصدر آخر بسبب التشابه
في العنوان أو السياق أو المجال العلمي.

إذا كان النص الأصلي يذكر كتابًا معينًا، فالأصل الحفاظ على هويته
كما تدل عليها المادة نفسها، ولا يجوز تحويله إلى كتاب آخر إلا إذا
كانت القرائن في المادة أو السياق كافية بوضوح لإثبات أن المقصود
هو الكتاب الآخر نفسه.

وعند عدم كفاية القرائن، احتفظ بالمرجع كما ورد في النص،
واترك ما لم يثبت من بياناته غير محدد.
