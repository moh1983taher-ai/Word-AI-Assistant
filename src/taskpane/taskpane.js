...
ومع المؤلف عندما تكون نسبته معلومة بدرجة موثوقة.

تعتمد هوية المرجع على مجموع خصائصه، لا على عنوانه وحده،
ومن ذلك عنوان الكتاب، والمؤلف، ومجاله العلمي، وسياق وروده،
ونوعه عند الحاجة. استخدم هذه الخصائص مجتمعة لتمييز الكتب
المتحدة أو المتشابهة في العنوان، وتحديد المرجع المقصود قبل
نسبة الكتاب إلى مؤلفه.

إذا كان عنوان الكتاب لا يُعرف به إلا كتاب واحد لمؤلف واحد،
فتقصَّ نسبته واعتمد مؤلفه الصحيح.

إذا كان المؤلف نفسه له كتب مختلفة، فكل كتاب مرجع مستقل،
ولا تدمج الكتب المختلفة للمؤلف نفسه.

إذا ورد عنوان الكتاب مع اسم مؤلفه في تركيب واحد يدل على
نسبته إليه، فافصل اسم المؤلف عن عنوان الكتاب، واجعل كلًّا
منهما في حقله الصحيح بحسب نمط التوثيق المختار.

لا تفصل اسمًا من عنوان المرجع لمجرد كونه اسم شخص، فإذا كان
الاسم جزءًا أصيلًا من عنوان الكتاب فابقه ضمن العنوان.
...
غير المذكور في الحاشية اعتمادًا على معرفة الكتاب وهويته
العلمية.

استخدم اسم الشهرة العلمي المختصر المناسب للتوثيق.

إذا عرفت مؤلف الكتاب من هويته ومجاله وسياقه، فأدرج المؤلف
الصحيح.

إذا تعذر التعرف على المؤلف، فاترك author فارغًا.
`
}
=====================================================
