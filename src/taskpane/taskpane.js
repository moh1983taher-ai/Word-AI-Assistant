...
ومع المؤلف عندما يكون معلومًا بدرجة موثوقة.

عند كون الكتاب أو المصدر معروفًا ومشهورًا باسم مؤلفه، اعتمد
نسبته العلمية المعروفة ولا تنسبه إلى مؤلف آخر، ولو ورد في
السياق اسم مؤلف آخر.

إذا كان عنوان الكتاب أو المصدر مميزًا ولا يلتبس بمرجع آخر،
فثبّت نسبته إلى مؤلفه المعروف علميًا، ولا تنسبه إلى مؤلف آخر
بسبب ورود اسم مختلف في السياق. 

إذا كان المؤلف نفسه له كتب مختلفة، فكل كتاب مرجع مستقل،
ولا تدمج الكتب المختلفة للمؤلف نفسه.

إذا وردت صيغة المرجع مشتملة على عنوان الكتاب واسم مؤلفه
في تركيب واحد يدل على نسبة الكتاب إليه، فافصل بينهما عند
إخراج المرجع بحسب نمط التوثيق المختار، بحيث يكون اسم
المؤلف في خانة المؤلف وعنوان الكتاب في خانة العنوان.

لا تفترض أن كل اسم داخل عنوان المرجع هو مؤلف، بل ميّز بين
اسم المؤلف وبين الاسم الذي يعد جزءًا أصيلًا من عنوان الكتاب.

إذا كان للعنوان كتاب مستقل وشرح أو حاشية أو تعليق،
فلا تفترض أن أحدها هو الآخر، ولا تحوّل عنوانًا إلى عنوان
شرح أو حاشية أو تعليق لمجرد التشابه بين العناوين.

إذا كان النص الأصلي يذكر مرجعًا معينًا بوضوح،
فحافظ على هويته كما وردت في المادة الأصلية.

=====================================================
3. نسبة الكتاب إلى المؤلف
=====================================================

لا تخمّن اسم المؤلف لمجرد تشابه العنوان.

إذا كان عنوان الكتاب أو المصدر واضحًا،
وكان المؤلف غير مؤكد،
فاحتفظ بالمرجع كاملًا واترك author فارغًا.

لا تحذف المرجع بسبب عدم معرفة المؤلف.

اسم مؤلف غير مؤكد أسوأ من ترك خانة المؤلف فارغة.

إذا كان المؤلف مذكورًا في المادة نفسها بوضوح،
احتفظ به.

إذا كانت نسبة الكتاب إلى مؤلف معين غير مؤكدة،
فيمكن جعل:
...
${addMissingAuthors
    ? `
=====================================================
3.1 تقصي أسماء المؤلفين وفصلها عن عناوين الكتب
=====================================================

ابذل جهدًا معقولًا لتحديد مؤلف كل مرجع غير المذكور في
الحاشية اعتمادًا على معرفتك العلمية الموثوقة.

استخدم اسم الشهرة العلمي المختصر المناسب للتوثيق، وتجنب
سرد الاسم الكامل والنسب الطويل والألقاب غير اللازمة.

عند تحليل صيغة المرجع، إذا كان اسم المؤلف واردًا مع عنوان
الكتاب في تركيب يدل على نسبة الكتاب إلى مؤلفه، فافصل اسم
المؤلف عن عنوان الكتاب وضع كلًّا منهما في حقله الصحيح.

لا تفصل أي اسم لمجرد ظهوره داخل عنوان المرجع، ولا تعتمد
على وجود حرف أو أداة لغوية منفردة للحكم بأنه اسم مؤلف.

إذا كان الاسم جزءًا أصيلًا من الاسم المعروف للكتاب أو من
عنوانه، فيبقى ضمن العنوان ولا يُجعل مؤلفًا.

حافظ على عنوان الكتاب كما هو، ولا تنشئ عنوانًا جديدًا بسبب
فصل المؤلف.

إذا تعذر تحديد المؤلف بدرجة كافية من الثقة، فاترك author
فارغًا واجعل needsReview = true.
`
    : `
=====================================================
...
عند تفعيل هذا الخيار، حاول تحديد المؤلف الحقيقي لكل مرجع
غير المذكور في الحاشية اعتمادًا على معرفتك العلمية الموثوقة.

استخدم اسم الشهرة العلمي المختصر المناسب للتوثيق.

إذا كانت نسبة الكتاب إلى مؤلفه معروفة لديك بدرجة كافية،
فأدرج المؤلف الصحيح.

إذا لم تكن النسبة مؤكدة، فاترك author فارغًا.
`
}
=====================================================
