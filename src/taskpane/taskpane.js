...
المرجع ونمط التوثيق المختار، واحذف من العنوان صيغة النسبة
التي تكرر اسم المؤلف.

لا تفصل اسمًا من عنوان المرجع لمجرد كونه اسم شخص، فإذا كان
جزءًا أصيلًا من الاسم المعروف للكتاب فابقه ضمن العنوان.
...
عند تفعيل هذا الخيار، حاول استكمال مؤلف المرجع غير المذكور
في الحاشية، بعد تحديد الكتاب المقصود.

اعتمد فقط على معلومات ببليوغرافية موثوقة عن الكتاب نفسه.
لا تستنتج المؤلف من عنوان الكتاب أو مجاله أو سياقه أو من
أسماء المؤلفين الواردة في مراجع أخرى.

إذا كان مؤلف الكتاب معروفًا لديك معرفة ببليوغرافية موثوقة،
فأدرجه باسم الشهرة العلمي المختصر.

إذا لم تتوفر لديك معلومة موثوقة تثبت المؤلف، فاترك author فارغًا.
`
    : `
=====================================================
3.1 تقصي أسماء المؤلفين
